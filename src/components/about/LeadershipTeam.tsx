  ...
  return (
    <div className="space-y-6 md:space-y-8">
            <LeaderCard
              ...
              imageAlt="Bethany Roberts Mann"
              imageClassName="object-cover object-left lg:object-[90%_center]"
              bioColumns
              >
              <p>
            ...
            <LeaderCard
              ...
              Impact and Intervention for twenty years.
              </p>
              <p>
              Before retiring from full-time practice in 2019, she was the Interim Director of the Osher Center
              for Integrative Medicine. Dr. Manning received her PhD from the University of Texas at Austin and
              has completed advanced training in somatic psychotherapy, mindfulness-based practices, and the
              treatment of trauma.
              </p>
              </LeaderCard>
            <LeaderCard
              ...
              imageAlt="Dan Mann"
              imageClassName="object-cover object-center lg:object-[80%_center]"
              bioColumns
              >
              <p>
            ...
            <LeaderCard
              ...
              imageAlt="The Reverend Richard Wineland"
              bioColumns
              >
              <p>
